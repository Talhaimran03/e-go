...
// Funzione per elaborare ogni file nella cartella
function processFile($filename, $conn)
{
    ...
    // Itera sui dati delle fermate dei bus e li inserisce nel database
...
// Directory in cui sono presenti i file GeoJSON
$directory = "data";

// Itera su ogni file nella directory
foreach (glob($directory . "/*.geojson") as $filename) {
    // echo($filename);
    processFile($filename, $conn);
}
